...
import { listarConjuntosID } from "../../../controllers/SensorConjuntoController";
...
export default function Conjunto_sensores({navigation}){
    ...
    const removeConjunto = (conjunto, index) => {
        console.log(listarConjuntosID(conjunto.id))
        console.log("aqui")
    ...
    return(
        <View style={style.viewSize}>
            ...
            <LinearGradient style = {style.container}
                ...
                <BotaoAdicionar adicionarItem={() => navigation.navigate("Cadastro conjunto de sensores")} nomeBotao={"ADICIONAR CONJUNTO de SENSOR"}/>
